...
def test_input_shape():
    ...
    model, device = image_deblur.get_deblur_model()
...
def export_onnx_model():
    import onnx
    import onnxruntime
    # from onnxsim import simplify # error !!!
    ...
    onnx_filename = "output/image_deblur.onnx"
    ...
    # !!! onnxsim not support nn.PixelUnshuffle !!! 
